...
export const plansList: PlanItem[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Tripo 3D support (Coming in Next Version)",
  ...
  },
  {
    ...
    originalPrice: "$29.99",
    savings: "Save ~33%",
    subtitle: "One-time payment forever & always priority of beta versions",
    ...
    features: [
      ...
      "Always priority access to all beta versions",
      "Tripo 3D support (Coming in Next Version)",
      "Expanded Community download formats (Next Version)",
